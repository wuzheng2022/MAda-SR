...
class MY(nn.Module):
    def __init__(self, n_feats, act=nn.ReLU(True)):
        ...
        self.fuse1 = SRBW2(
            n_feats * 2)  # nn.Conv2d(2*n_feats, n_feats, kernel_size=3, stride=1, padding=1, bias=False, dilation=1)
